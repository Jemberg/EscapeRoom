...
{
   public GameObject prefabToSpawn; // Drag the prefab you want to spawn into this field in the Inspector


   public void SpawnTheBasketball()
    {
        // Modify the position and rotation of the prefab
        Vector3 spawnPosition = transform.position + new Vector3(0, 1, 1); // move the prefab 1 unit to the right and 1 unit up
        ...
        Destroy(spawnedObject.gameObject, 20.0f);
    }
}
